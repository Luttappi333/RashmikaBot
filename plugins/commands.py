...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🤠ᴀʙᴏᴜᴛ🤠', url=f"https://t.me/{temp.U_NAME}")
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('⚠️ꜱᴇᴀʀᴄʜ⚠️', switch_inline_query_current_chat=''), 
                    InlineKeyboardButton('🦋ꜱᴜᴩᴩᴏʀᴛ🦋', url=GRP_LNK)
                 ],[
                    ...
                    reply_markup=InlineKeyboardMarkup(
                          [
                           [
                            ...
                            InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url=f"https://t.me/kombotzz")
                          ]
                        ]
                    )
                )   
